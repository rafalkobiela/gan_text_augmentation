...
# from models.SeqGAN_D import Seg
# from models.SeqGAN_G import SeqGAN_G
from config import Config
from gans.SeqGanDiscriminator import SeqGanDiscriminator
from gans.SeqGanGenerator import SeqGanGenerator
from gans.instructor import BasicInstructor
...
class SeqGANInstructor(BasicInstructor):
    def __init__(self, opt):
        ...
        self.gen = SeqGanGenerator(cfg.gen_embed_dim, cfg.gen_hidden_dim, cfg.vocab_size, cfg.max_seq_len,
                            cfg.padding_idx, gpu=cfg.CUDA)
        self.dis = SeqGanDiscriminator(cfg.dis_embed_dim, cfg.vocab_size, cfg.padding_idx, gpu=cfg.CUDA)
        self.init_model()
